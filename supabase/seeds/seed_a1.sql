...
begin
  ...
  -- Module 3: Wohnen
  insert into public.course_modules (level_id, title, description, objectives, order_index, estimated_hours, is_published)
  values ('A1', 'Wohnen', 'Learn vocabulary about homes, furniture, and describing where you live.', '["Describe your home and rooms","Name furniture and household items","Use prepositions of location","Talk about apartment hunting"]', 3, 5.0, true)
  returning id into m_id;
  ...
  insert into public.course_modules (level_id, title, description, objectives, order_index, estimated_hours, is_published)
  values ('A1', 'Einkaufen und Essen', 'Learn shopping vocabulary, food names, and how to order in restaurants.', '["Name foods and drinks","Shop for groceries","Order in a restaurant","Understand prices and pay","Use \"möchten\" for polite requests"]', 4, 5.0, true)
  returning id into m_id;
  ...
  insert into public.course_modules (level_id, title, description, objectives, order_index, estimated_hours, is_published)
  values ('A1', 'Arbeit und Beruf', 'Learn vocabulary for jobs, workplaces, and basic professional communication.', '["Name common professions","Talk about your job","Describe workplace activities","Use numbers for phone and email","Schedule appointments"]', 5, 5.0, true)
  returning id into m_id;
  ...
  insert into public.course_modules (level_id, title, description, objectives, order_index, estimated_hours, is_published)
  values ('A1', 'Reisen und Freizeit', 'Learn travel vocabulary, transportation, and leisure activities.', '["Book accommodations and transportation","Ask for and give directions","Talk about hobbies and free time","Use the verb \"fahren\" and direction words"]', 6, 5.0, true)
  returning id into m_id;
