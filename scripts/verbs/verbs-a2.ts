...
export const a2Verbs: VerbEntry[] = [
  ...
  reflexivePronounCase: 'dativ', en: 'to get used to', ar: 'يعتاد', fr: 's\'habituer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gewöhnt', reflexive: true, reflexivePronoun: 'sich', tags: ['daily_life', 'change'] },
...
{ infinitive:'verbieten', en:'to forbid', ar:'يمنع', fr:'interdire', level:'A2', freq:'common', type:'irregular', tr:'transitive', obj:'akkusativ', aux:'haben', p2:'verboten', tags:['rules'] },
  ...
  reflexivePronounCase: 'dativ', en: 'to wish', ar: 'يتمنى', fr: 'souhaiter', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gewünscht', reflexive: true, reflexivePronoun: 'sich', tags: ['wishes'] },
  ...
  reflexivePronounCase: 'dativ', en: 'to break a habit', ar: 'يتخلص من عادة', fr: 'se déshabituer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'abgewöhnt', reflexive: true, reflexivePronoun: 'sich', sep: 'ab', tags: ['habits'] },
  { infinitive: 'sich angewöhnen',
  reflexivePronounCase: 'dativ', en: 'to get used to', ar: 'يعتاد على', fr: 's\'habituer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'angewöhnt', reflexive: true, reflexivePronoun: 'sich', sep: 'an', tags: ['habits'] },
