...
export const a2Verbs: VerbEntry[] = [
  ...
  { infinitive: 'sich ausruhen', en: 'to rest', ar: 'يستريح', fr: 'se reposer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'ausgeruht', reflexive: true, reflexivePronoun: 'sich', tags: ['daily_life', 'health'] },
  { infinitive: 'sich anziehen', en: 'to get dressed', ar: 'يرتدي', fr: 's\'habiller', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'angezogen', reflexive: true, reflexivePronoun: 'sich', tags: ['daily_life', 'clothing'] },
  { infinitive: 'sich ausziehen', en: 'to undress', ar: 'يخلع', fr: 'se déshabiller', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'ausgezogen', reflexive: true, reflexivePronoun: 'sich', tags: ['daily_life', 'clothing'] },
  { infinitive: 'sich waschen', en: 'to wash oneself', ar: 'يغتسل', fr: 'se laver', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gewaschen', reflexive: true, reflexivePronoun: 'sich', tags: ['hygiene', 'daily_life'] },
  { infinitive: 'sich duschen', en: 'to shower', ar: 'يستحم', fr: 'se doucher', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'geduscht', reflexive: true, reflexivePronoun: 'sich', tags: ['hygiene', 'daily_life'] },
  { infinitive: 'sich rasieren', en: 'to shave', ar: 'يحلق', fr: 'se raser', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'rasiert', reflexive: true, reflexivePronoun: 'sich', tags: ['hygiene', 'daily_life'] },
  { infinitive: 'sich kämmen', en: 'to comb one\'s hair', ar: 'يمشط', fr: 'se peigner', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gekämmt', reflexive: true, reflexivePronoun: 'sich', tags: ['hygiene', 'daily_life'] },
  ...
  { infinitive: 'sich erkälten', en: 'to catch a cold', ar: 'يصاب بنزلة برد', fr: 's\'enrhumer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'erkältet', reflexive: true, reflexivePronoun: 'sich', tags: ['health', 'illness'] },
  ...
  { infinitive: 'sich fühlen', en: 'to feel', ar: 'يشعر', fr: 'se sentir', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gefühlt', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings', 'health'] },
  { infinitive: 'sich erholen', en: 'to recover', ar: 'يتعافى', fr: 'se rétablir', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'erholt', reflexive: true, reflexivePronoun: 'sich', tags: ['health', 'recovery'] },
  ...
  { infinitive: 'sich unterhalten', en: 'to converse', ar: 'يتحدث', fr: 'converser', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'unterhalten', reflexive: true, reflexivePronoun: 'sich', tags: ['communication', 'social'] },
  ...
  { infinitive: 'sich entspannen', en: 'to relax', ar: 'يسترخي', fr: 'se détendre', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'entspannt', reflexive: true, reflexivePronoun: 'sich', tags: ['free_time', 'health'] },

  // === FEELINGS EXTENDED ===
  { infinitive: 'sich ärgern', en: 'to get annoyed', ar: 'ينزعج', fr: 's\'énerver', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'geärgert', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings', 'emotions'] },
  { infinitive: 'sich freuen', en: 'to be happy', ar: 'يفرح', fr: 'se réjouir', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gefreut', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings', 'emotions'] },
  { infinitive: 'sich wundern', en: 'to wonder', ar: 'يتعجب', fr: 's\'étonner', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gewundert', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings', 'thought'] },
  { infinitive: 'sich langweilen', en: 'to be bored', ar: 'يضجر', fr: 's\'ennuyer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gelangweilt', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings', 'emotions'] },
  { infinitive: 'sich schämen', en: 'to be ashamed', ar: 'يخجل', fr: 'avoir honte', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'geschämt', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings', 'emotions'] },
  { infinitive: 'sich kümmern', en: 'to care about', ar: 'يهتم', fr: 's\'occuper de', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gekümmert', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings', 'relationships'] },
  { infinitive: 'sich sorgen', en: 'to worry', ar: 'يقلق', fr: 's\'inquiéter', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gesorgt', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings', 'emotions'] },
  { infinitive: 'sich gewöhnen', en: 'to get used to', ar: 'يعتاد', fr: 's\'habituer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gewöhnt', reflexive: true, reflexivePronoun: 'sich', tags: ['daily_life', 'change'] },

  // === RELATIONSHIPS ===
  { infinitive: 'sich treffen', en: 'to meet (each other)', ar: 'يلتقي', fr: 'se rencontrer', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'getroffen', reflexive: true, reflexivePronoun: 'sich', tags: ['social', 'relationships'] },
  { infinitive: 'sich verabschieden', en: 'to say goodbye', ar: 'يودع', fr: 'dire au revoir', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'verabschiedet', reflexive: true, reflexivePronoun: 'sich', tags: ['social', 'communication'] },
  { infinitive: 'sich verlieben', en: 'to fall in love', ar: 'يقع في الحب', fr: 'tomber amoureux', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'verliebt', reflexive: true, reflexivePronoun: 'sich', tags: ['relationships', 'feelings'] },
  { infinitive: 'sich streiten', en: 'to argue', ar: 'يتجادل', fr: 'se disputer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gestritten', reflexive: true, reflexivePronoun: 'sich', tags: ['relationships', 'communication'] },
  { infinitive: 'sich vertragen', en: 'to get along', ar: 'يتوافق', fr: 's\'entendre', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'vertragen', reflexive: true, reflexivePronoun: 'sich', tags: ['relationships', 'social'] },
  { infinitive: 'sich trennen', en: 'to separate', ar: 'ينفصل', fr: 'se séparer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'getrennt', reflexive: true, reflexivePronoun: 'sich', tags: ['relationships'] },
  ...
  { infinitive: 'sich beschweren', en: 'to complain', ar: 'يشكو', fr: 'se plaindre', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'beschwert', reflexive: true, reflexivePronoun: 'sich', tags: ['communication', 'service'] },
  { infinitive: 'sich entschuldigen', en: 'to apologize', ar: 'يعتذر', fr: 's\'excuser', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'entschuldigt', reflexive: true, reflexivePronoun: 'sich', tags: ['communication', 'politeness'] },
...
{ infinitive: 'sich anmelden', en: 'to register', ar: 'يسجل نفسه', fr: 's’inscrire', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'angemeldet', reflexive: true, reflexivePronoun: 'sich', tags: ['administration'] },

{ infinitive: 'sich abmelden', en: 'to deregister', ar: 'يلغي التسجيل', fr: 'se désinscrire', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'abgemeldet', reflexive: true, reflexivePronoun: 'sich', tags: ['administration'] },
...
{ infinitive:'sich erinnern', en:'to remember', ar:'يتذكر', fr:'se souvenir', level:'A2', freq:'very_common', type:'reflexive', tr:'intransitive', obj:'none', aux:'haben', p2:'erinnert', reflexive:true, reflexivePronoun:'sich', tags:['memory'] },
...
{ infinitive:'verbieten', en:'to forbid', ar:'يمنع', fr:'interdire', level:'A2', freq:'common', type:'irregular', tr:'transitive', obj:'akkusativ', aux:'haben', p2:'verboten', tags:['rules'] },
  ...
  { infinitive: 'sich bedanken', en: 'to thank', ar: 'يشكر', fr: 'remercier', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'bedankt', reflexive: true, reflexivePronoun: 'sich', tags: ['communication', 'politeness'] },
  { infinitive: 'sich beeilen', en: 'to hurry', ar: 'يستعجل', fr: 'se dépêcher', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'beeilt', reflexive: true, reflexivePronoun: 'sich', tags: ['daily_life'] },
  { infinitive: 'sich befinden', en: 'to be located', ar: 'يوجد / يكون في مكان', fr: 'se trouver', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'befunden', reflexive: true, reflexivePronoun: 'sich', tags: ['location'] },
  { infinitive: 'sich beklagen', en: 'to complain', ar: 'يشتكي', fr: 'se plaindre', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'beklagt', reflexive: true, reflexivePronoun: 'sich', tags: ['communication'] },
  { infinitive: 'sich entscheiden', en: 'to decide', ar: 'يقرر', fr: 'se décider', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'entschieden', reflexive: true, reflexivePronoun: 'sich', tags: ['decisions'] },
  { infinitive: 'sich einigen', en: 'to agree', ar: 'يتفق', fr: 's\'accorder', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'geeinigt', reflexive: true, reflexivePronoun: 'sich', tags: ['communication'] },
  { infinitive: 'sich einleben', en: 'to settle in', ar: 'يتأقلم مع مكان جديد', fr: 's\'installer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'eingelebt', reflexive: true, reflexivePronoun: 'sich', sep: 'ein', tags: ['daily_life'] },
  { infinitive: 'sich einstellen', en: 'to adjust', ar: 'يضبط نفسه', fr: 's\'adapter', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'eingestellt', reflexive: true, reflexivePronoun: 'sich', sep: 'ein', tags: ['daily_life'] },
  { infinitive: 'sich informieren', en: 'to inform oneself', ar: 'يستعلم / يحصل على معلومات', fr: 's\'informer', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'informiert', reflexive: true, reflexivePronoun: 'sich', tags: ['communication'] },
  { infinitive: 'sich interessieren', en: 'to be interested', ar: 'يهتم بـ', fr: 's\'intéresser', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'interessiert', reflexive: true, reflexivePronoun: 'sich', tags: ['feelings'] },
  { infinitive: 'sich irren', en: 'to be mistaken', ar: 'يخطئ', fr: 'se tromper', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'geirrt', reflexive: true, reflexivePronoun: 'sich', tags: ['communication'] },
  { infinitive: 'sich lohnen', en: 'to be worth it', ar: 'يستحق', fr: 'valoir la peine', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gelohnt', reflexive: true, reflexivePronoun: 'sich', tags: ['evaluation'] },
  { infinitive: 'sich melden', en: 'to report/contact', ar: 'يتصل / يبلغ', fr: 'se manifester', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gemeldet', reflexive: true, reflexivePronoun: 'sich', tags: ['communication'] },
  { infinitive: 'sich nähern', en: 'to approach', ar: 'يقترب', fr: 's\'approcher', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'genähert', reflexive: true, reflexivePronoun: 'sich', tags: ['movement'] },
  { infinitive: 'sich orientieren', en: 'to orient oneself', ar: 'يوجه نفسه', fr: 's\'orienter', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'orientiert', reflexive: true, reflexivePronoun: 'sich', tags: ['navigation'] },
  { infinitive: 'sich registrieren', en: 'to register', ar: 'يسجل', fr: 's\'inscrire', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'registriert', reflexive: true, reflexivePronoun: 'sich', tags: ['administration'] },
  { infinitive: 'sich schützen', en: 'to protect oneself', ar: 'يحمي نفسه', fr: 'se protéger', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'geschützt', reflexive: true, reflexivePronoun: 'sich', tags: ['safety'] },
  { infinitive: 'sich setzen', en: 'to sit down', ar: 'يجلس', fr: 's\'asseoir', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gesetzt', reflexive: true, reflexivePronoun: 'sich', tags: ['daily_life', 'position'] },
  { infinitive: 'sich umziehen', en: 'to change clothes', ar: 'يغير الملابس', fr: 'se changer', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'umgezogen', reflexive: true, reflexivePronoun: 'sich', sep: 'um', tags: ['daily_life', 'clothing'] },
  { infinitive: 'sich verabreden', en: 'to arrange to meet', ar: 'يتواعد / يتفق على لقاء', fr: 'se donner rendez-vous', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'verabredet', reflexive: true, reflexivePronoun: 'sich', tags: ['social'] },
  { infinitive: 'sich verbessern', en: 'to improve', ar: 'يتحسن', fr: 's\'améliorer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'verbessert', reflexive: true, reflexivePronoun: 'sich', tags: ['improvement'] },
  { infinitive: 'sich vorstellen', en: 'to introduce oneself', ar: 'يقدم نفسه / يتخيل', fr: 'se présenter', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'vorgestellt', reflexive: true, reflexivePronoun: 'sich', sep: 'vor', tags: ['communication', 'introduction'] },
  { infinitive: 'sich vorbereiten', en: 'to prepare', ar: 'يستعد', fr: 'se préparer', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'vorbereitet', reflexive: true, reflexivePronoun: 'sich', sep: 'vor', tags: ['preparation'] },
  { infinitive: 'sich wehren', en: 'to defend oneself', ar: 'يدافع عن نفسه', fr: 'se défendre', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gewehrt', reflexive: true, reflexivePronoun: 'sich', tags: ['conflict'] },
  { infinitive: 'sich wiederholen', en: 'to repeat', ar: 'يتكرر', fr: 'se répéter', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'wiederholt', reflexive: true, reflexivePronoun: 'sich', sep: 'wieder', tags: ['repetition'] },
  { infinitive: 'sich wünschen', en: 'to wish', ar: 'يتمنى', fr: 'souhaiter', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gewünscht', reflexive: true, reflexivePronoun: 'sich', tags: ['wishes'] },
  { infinitive: 'sich auskennen', en: 'to know well', ar: 'يعرف جيداً / يكون على دراية', fr: 'se connaître', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'ausgekannt', reflexive: true, reflexivePronoun: 'sich', sep: 'aus', tags: ['knowledge'] },
  { infinitive: 'sich ausdrücken', en: 'to express oneself', ar: 'يعبر عن نفسه', fr: 's\'exprimer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'ausgedrückt', reflexive: true, reflexivePronoun: 'sich', sep: 'aus', tags: ['communication'] },
  { infinitive: 'sich abgewöhnen', en: 'to break a habit', ar: 'يتخلص من عادة', fr: 'se déshabituer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'abgewöhnt', reflexive: true, reflexivePronoun: 'sich', sep: 'ab', tags: ['habits'] },
  { infinitive: 'sich angewöhnen', en: 'to get used to', ar: 'يعتاد على', fr: 's\'habituer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'angewöhnt', reflexive: true, reflexivePronoun: 'sich', sep: 'an', tags: ['habits'] },
  { infinitive: 'sich aufregen', en: 'to get upset', ar: 'ينزعج / يتوتر', fr: 's\'énerver', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'aufgeregt', reflexive: true, reflexivePronoun: 'sich', sep: 'auf', tags: ['emotions'] },
  { infinitive: 'sich beschäftigen', en: 'to occupy oneself', ar: 'ينشغل بـ', fr: 's\'occuper', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'beschäftigt', reflexive: true, reflexivePronoun: 'sich', sep: 'be', tags: ['daily_life'] },
  { infinitive: 'sich entfernen', en: 'to move away', ar: 'يبتعد', fr: 's\'éloigner', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'entfernt', reflexive: true, reflexivePronoun: 'sich', sep: 'entfernt', tags: ['movement'] },
  { infinitive: 'sich ergeben', en: 'to result', ar: 'ينتج / يظهر', fr: 'résulter', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'ergeben', reflexive: true, reflexivePronoun: 'sich', sep: 'er', tags: ['results'] },
  { infinitive: 'sich handeln', en: 'to be about', ar: 'يتعلق الأمر بـ', fr: 's\'agir de', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gehandelt', reflexive: true, reflexivePronoun: 'sich', tags: ['topics'] },
  { infinitive: 'sich melden', en: 'to contact', ar: 'يتواصل', fr: 'se manifester', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'gemeldet', reflexive: true, reflexivePronoun: 'sich', tags: ['communication'] },
  { infinitive: 'sich niederlassen', en: 'to settle down', ar: 'يستقر', fr: 's\'installer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'niedergelassen', reflexive: true, reflexivePronoun: 'sich', sep: 'nieder', tags: ['living'] },
  { infinitive: 'sich reduzieren', en: 'to reduce', ar: 'ينخفض', fr: 'se réduire', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'reduziert', reflexive: true, reflexivePronoun: 'sich', tags: ['reduction'] },
  { infinitive: 'sich täuschen', en: 'to be mistaken', ar: 'يخطئ / يخدع نفسه', fr: 'se tromper', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'getäuscht', reflexive: true, reflexivePronoun: 'sich', tags: ['mistakes'] },
  { infinitive: 'sich verlassen', en: 'to rely on', ar: 'يعتمد على / يغادر', fr: 'compter sur', level: 'A2', freq: 'very_common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'verlassen', reflexive: true, reflexivePronoun: 'sich', sep: 'ver', tags: ['trust'] },
  { infinitive: 'sich vornehmen', en: 'to intend', ar: 'ينوي / يقرر القيام بـ', fr: 'se proposer', level: 'A2', freq: 'common', type: 'reflexive', tr: 'intransitive', obj: 'none', aux: 'haben', p2: 'vorgenommen', reflexive: true, reflexivePronoun: 'sich', sep: 'vor', tags: ['intentions'] },
]
