...
// Map of infinitive → case for ALL reflexive verbs
const REFLEXIVE_CASE_MAP = {
  'sich abmelden': 'akkusativ',
  'sich abgewöhnen': 'dativ',
  'sich angewöhnen': 'dativ',
  'sich anmelden': 'akkusativ',
  'sich anziehen': 'akkusativ',
  'sich ärgern': 'akkusativ',
  'sich aufregen': 'akkusativ',
  'sich ausdrücken': 'akkusativ',
  'sich auskennen': 'akkusativ',
  'sich ausruhen': 'akkusativ',
  'sich ausziehen': 'akkusativ',
  'sich bedanken': 'akkusativ',
  'sich beeilen': 'akkusativ',
  'sich befinden': 'akkusativ',
  'sich beklagen': 'akkusativ',
  'sich beschäftigen': 'akkusativ',
  'sich beschweren': 'akkusativ',
  'sich bewerben': 'akkusativ',
  'sich duschen': 'akkusativ',
  'sich einigen': 'akkusativ',
  'sich einleben': 'akkusativ',
  'sich einstellen': 'akkusativ',
  'sich entfernen': 'akkusativ',
  'sich entscheiden': 'akkusativ',
  'sich entschuldigen': 'akkusativ',
  'sich entspannen': 'akkusativ',
  'sich ergeben': 'akkusativ',
  'sich erholen': 'akkusativ',
  'sich erinnern': 'akkusativ',
  'sich erkälten': 'akkusativ',
  'sich freuen': 'akkusativ',
  'sich fühlen': 'akkusativ',
  'sich gewöhnen': 'akkusativ',
  'sich handeln': 'akkusativ',
  'sich informieren': 'akkusativ',
  'sich interessieren': 'akkusativ',
  'sich irren': 'akkusativ',
  'sich kämmen': 'akkusativ',
  'sich konzentrieren': 'akkusativ',
  'sich kümmern': 'akkusativ',
  'sich langweilen': 'akkusativ',
  'sich lohnen': 'akkusativ',
  'sich melden': 'akkusativ',
  'sich nähern': 'akkusativ',
  'sich niederlassen': 'akkusativ',
  'sich orientieren': 'akkusativ',
  'sich rasieren': 'akkusativ',
  'sich reduzieren': 'akkusativ',
  'sich registrieren': 'akkusativ',
  'sich schämen': 'akkusativ',
  'sich schützen': 'akkusativ',
  'sich setzen': 'akkusativ',
  'sich sorgen': 'akkusativ',
  'sich streiten': 'akkusativ',
  'sich täuschen': 'akkusativ',
  'sich treffen': 'akkusativ',
  'sich trennen': 'akkusativ',
  'sich umziehen': 'akkusativ',
  'sich unterhalten': 'akkusativ',
  'sich verabreden': 'akkusativ',
  'sich verabschieden': 'akkusativ',
  'sich verbessern': 'akkusativ',
  'sich verlassen': 'akkusativ',
  'sich verlieben': 'akkusativ',
  'sich vertragen': 'akkusativ',
  'sich vorbereiten': 'akkusativ',
  'sich vornehmen': 'dativ',
  'sich vorstellen': 'dativ',
  'sich waschen': 'akkusativ',
  'sich wehren': 'akkusativ',
  'sich wiederholen': 'akkusativ',
  'sich wundern': 'akkusativ',
  'sich wünschen': 'dativ',
};
...
async function main() {
  ...
  // Step 2: Fetch all reflexive verbs from DB
  ...
  // Step 3: Update reflexive_pronoun_case for each verb
  console.log('\nStep 3: Updating reflexive_pronoun_case...');
  let updated = 0;
  for (const v of verbs) {
    const caseVal = REFLEXIVE_CASE_MAP[v.infinitive];
    if (caseVal) {
      await query(`UPDATE public.german_verbs SET reflexive_pronoun_case = '${caseVal}' WHERE id = '${v.id}'`);
      updated++;
    } else {
      console.log(`  WARNING: Unknown case for ${v.infinitive}, defaulting to akkusativ`);
      await query(`UPDATE public.german_verbs SET reflexive_pronoun_case = 'akkusativ' WHERE id = '${v.id}'`);
      updated++;
    }
  }
  console.log(`  Updated ${updated} verbs.`);

  // Step 4: Regenerate enriched content
  console.log('\nStep 4: Regenerating enriched content using fixed verb-enricher.ts...');
  const { generateExamples, generateCollocations, generateQuestions, generateMistakes, generateTips } = await import('./verbs/verb-enricher');
  ...
  for (const verb of verbs) {
    const caseVal = REFLEXIVE_CASE_MAP[verb.infinitive] || 'akkusativ';
    const entry = {
